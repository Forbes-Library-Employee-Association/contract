= Agreement Between Trustees of the Forbes Library and Forbes Library Employee Association (FLEA): JULY 1, 2022 to JUNE 30, 2023 =
:toc:
...
Unplanned time off, including sick leave, should be reported as soon as possible. 

Notification of unplanned time off should be given to an employee's direct supervisor 
no later than an hour before the start of their shift. Supervisors will notify the 
...
An employee may not begin the leave year with a balance in excess of twenty-five (25) 
vacation days. A member of the bargaining unit who leaves the employ of Forbes Library 
shall be paid for whatever leave balance exists as of the date of termination; no 
employee may be paid for more than twenty-five (25) vacation days of leave. 

Requests for vacation and flex should be submitted using the library's time off request
form that will be reviewed by the individual's supervisor and approved unless doing so 
would jeopardize the safe and effective operation of the library, as determined by the 
Library Director or designee.

Vacation leave should be requested no less than two (2) weeks in advance. 

Vacation requests will be approved on a first come basis, if requested 6 weeks ahead of 
time, regardless of seniority. 

If multiple vacation requets have been submitted for the same period, have yet to be 
approved, and not all requests can be honored, vacation will be approved based on
seniority, unless there is a compelling reason for the request by the less senior
staff member. 

Unplanned time off, including sick leave, should be reported as soon as possible. 

Notification of unplanned time off should be given to an employee's direct 
supervisor non later than an hour before the start of their shift. Supervisors
will notify the Business Office as soon as possible. 
...
Friday. An employee who is on jury duty for four (4) hours or less in a given day shall
...
Paid Family Medical Leave is a mandatory statewide insurance program that
will provide almost every Massachusetts employee with paid time off to give 
or receive care. 

Covered reasons and time off under the program::
If you qualitfy, this program will allow you to take up to 12 weeks to:
. Bond with a new child;
. To care for a family member with a serious health condition;
. Or for time needed to prepare for a family members's pre- and post-deployment
activities, as well as time for childcare issues related to a family member's 
military deployment ("qualifying exigency"). 

Up to 20 weeks is available under the program to attend to an employee's own 
serious health condition and up to 26 weeks is available to attend to an injured
family member. 

Despite the reasons stated above, the program is capped up to a total of 26 weeks
available in a 12-month period (which is measured on a rolling forward basis; 
commencing on the Sunday immediately preceding the onset of a PFML leave). 

Payment of premiums::
The program is funded by premiums paid by employers and in some cases employees. 
While the total premium (comprised statewide of both participating employer 
and employee contributions) was initially set at 0.75% of wages, this percentage
is subject to future change by the state as the program is administed by the 
Massachusetts Department of Family and Medical Leave (DFML). Currently, the 
library has volunteered to cover the employer and employee share. If this changes, 
employees' contribtions would be deducted from their paychecks. 

Based on the contribution rate in effect, Forbes Library will send our share and  
if applicable those of our employees to the state (through the MassTaxConnect
system) on a quarterly basis. Contribution rates and contribution amounts will 
be reviewed annually. 

Taking leave::
Starting in 2021, employees may begin to apply to the DFML for benefits under
this program. Therefore, employees seekingto take time off for covered reasons 
who intend to file for benefits with the DFML, need to provide Forbes Library 
with thirty (30) days advance notice when the leave is forseeable. For leaves
that are necessitated for reasons beyond the employees control, notice needs
to be provided as soon as practicable. The PFML leave will run concurrently 
with other leave programs as applicable. 

Benefits::
While an employee is required to provide notice to Forbes Library, Forbes Library
is not involved in the benefit claims process with the DFML. Employees 
seeking to apply for benefits need to reach out to the DFML at (833) 344-7365
and alert the Business Office of the intention to apply. Only the DFML can evaluate
your eligibilty for benefits and determine how much you will receive. WHile the
current maximum benefit is set at $850/week, this amount is subject to change 
and is reviewed annually. Similarly, not all employees may be eligible for benefits
as eligibilty is based on earnings. Any questions concerning benefit eligibilty or 
disputes surrounding a determination on this benefit; including options to 
appeal determinations should likewise be directed to the DFML at (833) 344-7365. 

Employee responsibilities during a PFML leave::
Employees who go out on leave covered under the DFML program are required 
to follow the periodic reporting and call-in procedures as set forth under
Forbes Library policies and procedures. Also, if an employee is on the Forbes
Library group health plan, you will be responsible to continue paying your 
portion of the premium cost while on leave. For further questions, please
contact the Business Office. 

Employee responsibilities upon returning from a PFML leave::
Employees who go out on a PFML leave for their own serious health condition 
are required to provide proof of fitness for duty from the health care 
provider prior to resuming their job responsibilities. 

Employee job protections::
Employeees who return from leave under this law will be restored to their 
previous or an equivalent position with the same status, pay, benefits and 
seniority. Forbes Library is prohibited from discrimination or retaliating
against you for requesting or taking leave. 
...
== Article XXII: RESIGNATION POLICY ==

The library recongnizes that there are certain aspects of employment that the
library can control and certain aspects that the employee can control. One of 
the areas that the employee can control is when they decide to leave the employ
of the Forbes Library. Forbes Library has adopted a policy of requiring a 
"notice period" when an employee makes the decision to end their employment 
relationship. This notice period gives the library the opportunity to make 
arrangements for a replacement and to organize the departure of the incumbent.
The purpose of this policy is to address some issues that arise when the 
employment relationship ends. 

. DEFINITION
  .. Notice period: a period of time (usually two to four weeks) after an
  employee has given their supervisior notice of their intention to leave the 
  employ of the library. The period usually begins the day notice is given and
  continues through the last day the employee performs any work for the library. 

  .. Job abandonment: when an employee fails to come to work for three (3) days 
  and does not call their supervisor for three (3) days and/or does not
  communicate with supervisor if working remotely according to the telecommuting
  agreement, it will be concluded that the employee has voluntarily resigned 
  their position with the library and their separation date will be documented
  as the last day they performed any work. 
  
. PROCEDURE:
When an employee makes the decision to leave their position with the library, 
the employee should give written notice to their supervisor. The employee 
should include in that notice when their last day of actual work will be. 
Employees should limit their use of paid time off (PTO) benefits (sick, personal 
or vacation time) during their notice period. Once their notice period has passed 
and the employee has worked their last day of work, the employee will receive a 
payout of all applicable PTO benefits in their next payroll check. 

The amount of notice given should match the employee's grade level. Grades 4-6 
should give their supervisor at least two weeks notice before their last day of
work. Grades 7-9 should give their supervisor at least three weeks notice. 
Grades 10-11 should give their supervisor at least four weeks notice. 

If an employee fails to give proper notice (i.e. walks off the job or give less
than two weeks' notice), the employee will not be eligible to be rehired by 
the library in the future. 

Employees are encouraged to schedule an Exit Interview with the Library Director
and/or Assistant Director before their last day of work. A meetingn with the 
Administrative Assistant is also required within a week of giving notice for 
information about benefits and payouts and coordination with the City's Human 
Resources Department. 

Continuation of group health insurance for terminal payout period: An employee 
who voluntarily separates from employment and gives appropriate notice and has 
two or more full weeks worth of vacation time accrued on their last day of 
work, may choose to have the vaction time paid out in bi-weekly amounts for up
to four weeks (two pay periods). During that terminal payout period, the 
employee could choose to continue their group health insurance for each week 
of full pay. Any remaining vacation balance would then be paid out in a final 
paycheck. Group health insurance benefits would end on the last day of the week
in which the employee was paid their regular scheduled hours in vacation time 
or after four (4) weeks, whichever is sooner. Employees cannot continue group
health insurance for any partial pay week. Once an employee is no longer
eligible for group health insrance, they will be given the option of continuing
coverage under COBRA. Employees exerciting this option would not accrue any 
vacation (or sick) time. All other benefits end on the employee's last day of work.

== Article XXIII: LONGEVITY COMPENSATION ==
...
== Article XXIV: ASSOCIATION REPRESENTATION ==
...
== Article XXV: ACCESS TO PREMISES/BULLETIN BOARDS ==
...
== Article XXVII: NO STRIKE, WORK SLOWDOWN OR LOCKOUT ==
...
== Article XXVIII: LEAVE OF ABSENCE ==
...
All employees are eligible to receive a contractual increase regardless of term 
of employment.

The Employer agrees to increase an employee's base salaries by two percent
(2.0%) during the period of time beginning July 1, 2022 and ending June 30,
2023.

The Employer agrees to pay a one time bonus of $1050 (pro-rated based on salaried
hours per week) in December 2022 to all current FLEA members who were working
as of June 2022. 
...
== Article XXXII: LABOR MANAGEMENT COMMITTEE ==
...
of October 2022 covers the period beginning July 1, 2022 and ending on June 30,
2023 provided that the Agreement shall remain in full force and effect until a
